...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'hero-gradient': 'linear-gradient(135deg, #F8F6FF 0%, #CCFBEF 30%, #FFFBEB 60%, #FCE7F3 100%)',
        'card-gradient': 'linear-gradient(135deg, #FFFEF7 0%, #F8F6FF 100%)',
        'button-gradient': 'linear-gradient(135deg, #E6E6FA 0%, #F9A8D4 100%)',
        'section-gradient': 'linear-gradient(to bottom, #F0FDF9 0%, #FFFBEB 100%)',
      },
      backdropBlur: {
        xs: '2px',
      },
