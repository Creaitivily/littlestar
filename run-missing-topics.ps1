# PowerShell script to populate missing topics
...
Write-Host "Populating missing topics..." -ForegroundColor Green
node populate-missing-topics.js
Write-Host "Finished populating missing topics!" -ForegroundColor Green